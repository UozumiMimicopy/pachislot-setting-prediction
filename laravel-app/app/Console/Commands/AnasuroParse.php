...
use App\Services\AnasuroParser;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\DB;

class AnasuroParse extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'anasuro:parse {file_path}';
     ...
     * @var string
     */
    protected $description = 'Parse Anasuro HTML file and save to database';

    /**
     * Execute the console command.
     */
    public function handle(AnasuroParser $parser)
    {
                    ...
                    try {
                        ...
                        MinrepoData::updateOrCreate(
                            ...
                            [
                                ...
                                'bb_count' => $machine['bb_count'],
                                'rb_count' => $machine['rb_count'],
                                'art_count' => $machine['art_count'],
                            ]
                        );
